...
$routes->get('/','loginController::homepage', ['filter' => 'auth']);
$routes->get('/logout','loginController::logout', ['filter' => 'auth']);
$routes->get('/ReferralHierarchy','loginController::ReferralHierarchy', ['filter' => 'auth']);
$routes->get('/DirectReferral','loginController::DirectReferral', ['filter' => 'auth']);
